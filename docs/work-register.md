...
| GSD-W018 | Session-start GitHub Copilot catalog refresh and runtime model activation | Upstream | PR required | [#1979](https://github.com/open-gsd/gsd-pi/pull/1979) | — | `feat/copilot-catalog-session-refresh` | **PR Ready for review** — Rebased directly onto `upstream/main` after PR #1978 merged (`926e55c1`). Marked ready for review (undrafted). All 229 tests green, `tsc` clean. | Monitor PR #1979 for maintainer review |
| GSD-W017 | Cheaper same-tier Copilot suggestions in `pricing`/`why`, plus proactive notifications | Upstream | PR required | [#1980](https://github.com/open-gsd/gsd-pi/pull/1980) | — | `feat/copilot-cheaper-model-suggestions` | **PR Ready for review** — Rebased onto PR #1979 (`4ae28ddb`). Marked ready for review (undrafted). All 266 tests green, `tsc` clean. | Monitor PR #1980 for maintainer review |
| GSD-W021 | Repair evidence-backed lifecycle shadow authority before Milestone validation | Upstream | PR required | [#2055](https://github.com/open-gsd/gsd-pi/issues/2055) | [#2002](https://github.com/open-gsd/gsd-pi/pull/2002) | `fix/lifecycle-shadow-authority-repair` | **PR open / Review fixes pushed** — Rebased onto `upstream/main`, unified single-step repair batch, enforced exact `passed` token, fixed test FK fixture (`647c4a07`). Linked issue #2055. | Await maintainer review/merge on PR #2002 |
...
| GSD-W014 | GitHub Copilot model-catalog sync (`/gsd copilot-models`) | Upstream | Historical | — | #1978 | Merged in `4b26a642` (2026-08-29) |
...
| GSD-W019 | `verify-merge` heavy-gate classifier and compile-once optimization | Upstream | Historical | — | #1990 | Merged in `31094b0f` (2026-08-28) |
| GSD-W020 | Repo-wide markdownlint config: disable MD013/MD060 | Upstream | Historical | #1992 | #1991 | Merged in `a1b55909` (2026-08-28) |
