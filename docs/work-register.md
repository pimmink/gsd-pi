...
| GSD-W019 | `verify-merge` heavy-gate classifier and compile-once optimization | Upstream | PR required | — | — | `perf/verify-merge-efficiency` | In progress — newly registered 2026-08-24. One real, already-pushed commit (`4062e065`) found untracked during a worktree audit: no upstream issue/PR, no prior register entry, 91 commits behind current upstream/main, no exact-SHA remote gate evidence yet. | **Needs a decision** (not yet actioned): rebase, gate, and open a PR — or drop it |
