...
| GSD-W014 | GitHub Copilot model-catalog sync (`/gsd copilot-models`) | Upstream | PR required | [#1978](https://github.com/open-gsd/gsd-pi/pull/1978) | — | `feat/github-copilot-model-catalog-sync` | **Merged upstream** — Merged into `open-gsd/gsd-pi:main` on 2026-08-29 (`4b26a642`). All 25 review findings resolved, `--register` registry refresh verified with tests, zh-CN docs translated. | — |
...
| GSD-W021 | Repair evidence-backed lifecycle shadow authority before Milestone validation | Upstream | PR required | [#2055](https://github.com/open-gsd/gsd-pi/issues/2055) | [#2002](https://github.com/open-gsd/gsd-pi/pull/2002) | `fix/lifecycle-shadow-authority-repair` | **PR open / Review fixes pushed & CI green** — Rebased onto `upstream/main`, fixed unit test FK fixture + combined single-step repair batch (`5bbba2b2`). Full GitHub CI run `33255711580` passed 100% green. Opened and linked issue #2055. | Await maintainer review/merge on PR #2002 |
