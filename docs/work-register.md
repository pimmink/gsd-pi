...
| GSD-W018 | Session-start GitHub Copilot catalog refresh and runtime model activation | Upstream | PR required | — | — | `feat/copilot-catalog-session-refresh` | In progress — stacked on W014 tip `7a81883a1187c07a3ce7dfd770caf2c520e7173b`; first exact-SHA full-gate (`32482885693`) failed on 2 real gaps (prefs-wizard fixture, ADR-012 allowlist), both fixed in `7961ebfa23e3732f97586192458af8f35f3e565d`; redispatched as run `32485730290`, result pending. | Await run `32485730290`; if green, rebase GSD-W017 onto this SHA |
