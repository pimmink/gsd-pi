...
| GSD-W029 | Truthful GitHub Copilot catalog normalization and bounded diagnostics | Upstream | PR required | [#2088](https://github.com/open-gsd/gsd-pi/issues/2088) | [#2092](https://github.com/open-gsd/gsd-pi/pull/2092) | `fix/copilot-catalog-truthful-normalization` | Complete / PR updated — `339d4320` pushed after rebase to current `upstream/main`; rejects literal placeholders, preserves unknown tool support, records provider-live/static transport conflicts, and requires authoritative input modality before overlay synthesis. Focused suites 82/82 green; extension typecheck and diff check green; Copilot review threads resolved | Wait for upstream CI and maintainer review on PR #2092 |
