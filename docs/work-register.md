...
| GSD-W014 | GitHub Copilot model-catalog sync (`/gsd copilot-models`) | Upstream | PR required | — | — | `feat/github-copilot-model-catalog-sync` | In progress — rebased to `7a81883a1187c07a3ce7dfd770caf2c520e7173b` on current `upstream/main` `6a310619c187a3d940adc29e282c7d39246739b1`; local focused W014 regression `209/209` and `typecheck:extensions` are green. Historical exact-SHA remote full-gate evidence for `6d0ccb73176841c927e5f16a34d73db0d97011f1` is now superseded by this rebase and must be rerun. | Rerun exact-SHA `verify:pr` and `verify:merge` for `7a81883a1187c07a3ce7dfd770caf2c520e7173b` before any GitHub write |
